            ...
            <form action="{{ route('resources.update', $resource->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                        placeholder="Ex.: Listar Tópicos" value="{{ $resource->name }}">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('resource') is-invalid @enderror" name="resource"
                        placeholder="Ex.: threads.index" value="{{ $resource->resource }}">
                    @error('resource')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="custom-control custom-radio">
                        <input type="radio" id="isMenu1" name="is_menu" class="custom-control-input" value="1"
                            @if ($resource->is_menu) checked @endif>
