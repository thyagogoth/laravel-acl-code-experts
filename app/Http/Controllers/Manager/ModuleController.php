...
class ModuleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.modules.index', ['modules' => $modules]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('manager.modules.edit', ['module' => $module]);
    }
    ...
    public function syncResources(Module $module, Resource $resource)
    {
        ...
        return view('manager.modules.sync-resources', ['module' => $module, 'resources' => $resources]);
    }
